...
export const purchasePriceSchema = z.int("Le prix doit être un nombre");
export const purchaseDateSchema = z.date("Le format de la date est invalide");
export const sellpriceSchema = z.int("Le prix doit être un nombre");
export const sellDateSchema = z.date("Le format de la date est invalide");
