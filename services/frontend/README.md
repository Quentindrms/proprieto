Generated with [vike.dev/new](https://vike.dev/new) ([version 587](https://www.npmjs.com/package/create-vike/v/0.0.587)) using this command:

```sh
pnpm create vike@latest --solid --tailwindcss --telefunc --fastify
```
