...
export default function PropertyCard(props: PropertyCardProps) {
    return (
        <div class="bg-background-surface w-md p-2">
            <div id="header" class="border border-background-border flex justify-between items-center" >
            ...
            <div id="body" class="flex flex-col gap-2 p-2">
